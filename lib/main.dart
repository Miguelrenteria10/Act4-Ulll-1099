...
import 'package:Renteria1099/firebase_options.dart';
...
class PaginaSesion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('CocaCola', style: TextStyle(color: Colors.white)),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/Miguelrenteria10/img-iOS/main/COMPRAENLINEA.jpg.png")),
